...
const InputForm = ({itemArray, disableDuplicateChkBtn, helper, isHelperError, value}: 
    {itemArray: InputItemType[], disableDuplicateChkBtn?: boolean, helper?: string, isHelperError?: boolean, value?: string}
  ) => {
